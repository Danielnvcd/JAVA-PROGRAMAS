...
public class JavaApplication16 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            System.out.print("Ingrese un valor para vector1[" + i + "]: ");
            vector1[i] = input.nextInt();
        }

        System.out.println("Ingrese valores para vector2:");
        for (int i = 0; i < 5; i++) {
            System.out.print("Ingrese un valor para vector2[" + i + "]: ");
        ...
        System.out.println("resultado de vector1 - vector2:");
        for (int i = 0; i < 5; i++) {
...
public static void main(String[] args) {
        ...
        if (mes >= 1 && mes <= 12) {
            System.out.println("el mes " + mes + " tiene " + diasPorMes[mes] + " dias ");
        } else {
...
public class JavaApplication16 {
    ...
    public static void main(String[] args) {
        ...
        int[] edades = new int[maxAlumnos];
        int contador = 0;

        System.out.println("introduzca el nombre y la edad de cada alumno ingrese '*' como nombre para terminar ");
